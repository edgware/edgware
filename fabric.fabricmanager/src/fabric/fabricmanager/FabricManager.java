...
public class FabricManager extends FabricBus implements IBusServices, IFabricShutdownHookAction {
	...
	private IFabletDispatcher fabletDispatcherFactory() throws Exception {
		...
		FabricPlugin[] fablets = FabricRegistry.getFabricPluginFactory(true).getFabricPlugins(predicate);
	...
	private void announceAvailability() {
		...
		Node thisNode = FabricRegistry.getNodeFactory(true).getNodeById(homeNode());
	...
	public void shutdown() {
		...
		if (!shutdownInProgress) {
			...
			Node thisNode = FabricRegistry.getNodeFactory(true).getNodeById(name);
