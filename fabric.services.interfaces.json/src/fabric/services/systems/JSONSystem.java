...
public abstract class JSONSystem extends Fabric implements ISystem {
    ...
    public void cancelSubscriptionCallback() {
        ...
        /* No action required */
        FLog.enter(logger, Level.FINER, this, "cancelSubscriptionCallback", (Object[]) null);
    ...
    public String inputToJSON(IFeedMessage message) {
        ...
        String encoding = message.getProperty(IServiceMessage.PROPERTY_ENCODING);
    ...
    public String solicitedResponseToJSON(String correlationID, IFeedMessage message) {
        ...
        String json = String.format(SOLICITED_RESPONSE_JSON, //
                message.getProperty(IServiceMessage.PROPERTY_DELIVER_TO_SERVICE), // Solicit response
                payloadToString(message), // Payload
                message.getProperty(IServiceMessage.PROPERTY_REPLY_TO_SERVICE), // Request response
    ...
    public String requestResponsetoJSON(String correlationID, IFeedMessage message, ServiceDescriptor replyTo) {
        ...
        String json = String.format(REQUEST_RESPONSE_JSON, //
                message.getProperty(IServiceMessage.PROPERTY_DELIVER_TO_SERVICE), // Request response
                payloadToString(message), // Payload
    ...
    public String oneWayToJSON(IFeedMessage message) {
        ...
        String json = String.format(ONE_WAY_JSON, //
                message.getProperty(IServiceMessage.PROPERTY_DELIVER_TO_SERVICE), // Listener
                payloadToString(message), // Payload
                message.getProperty(IServiceMessage.PROPERTY_REPLY_TO_SERVICE), // Notification
                encoding); // Encoding
