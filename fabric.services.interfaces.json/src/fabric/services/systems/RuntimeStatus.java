...
public class RuntimeStatus extends FabricBus {
    ...
    /** System status codes. */
    public enum Status {
        NONE, OK, ALREADY_RUNNING, NOT_RUNNING, STILL_RUNNING, SEND_REQUEST_FAILED, SEND_NOTIFICATION_FAILED, NOT_FOUND, START_FAILED, ALREADY_SUBSCRIBED, SUBSCRIBE_FAILED, PUBLISH_FAILED, UNSUBSCRIBE_FAILED
    };
