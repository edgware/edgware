		...
		try {
			...
			if (typeid == null) {
				...
				status = new AdapterStatus(AdapterConstants.ERROR_PARSE, AdapterConstants.OP_CODE_REGISTER,
						AdapterConstants.ARTICLE_SERVICE_TYPE, AdapterConstants.STATUS_MSG_MISSING_FIELDS, correlId);
				...
				case "":
					...
					Type type = typeFactory.createServiceType(typeid, jsonOpObject
					...
					if (!success) {
						...
						status = new AdapterStatus(AdapterConstants.ERROR_ACTION, AdapterConstants.OP_CODE_REGISTER,
								AdapterConstants.ARTICLE_SERVICE_TYPE,
