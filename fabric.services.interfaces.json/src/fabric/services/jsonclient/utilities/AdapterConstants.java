...
public class AdapterConstants {
    ...
    public static final String OP_QUERY_SERVICE_WIRING = "query:service-wiring";
    public static final String OP_QUERY_RESPONSE_SERVICE_WIRING = "query-result:service-wiring";
    ...
    public static final String OP_LOST_SUBSCRIPTIONS = "lost-subscriptions";
    ...
    public static final String FIELD_AVAILABILE = "available";
    ...
    public static final String FIELD_CLIENT = "client-id";
    ...
    public static final String FIELD_FROM_INTERFACE = "from-interface";
    public static final String FIELD_FROM_PLATFORM = "from-platform";
    public static final String FIELD_FROM_SYSTEM = "from-system";
    ...
    public static final String FIELD_NEIGHBOUR_INTERFACE = "neighbour-interface";
    public static final String FIELD_NODE = "node";
    public static final String FIELD_NODES = "nodes";
    public static final String FIELD_NODE_INTERFACE = "node-interface";
    ...
    public static final String FIELD_SERVICE_WIRING = "service-wiring";
    public static final String FIELD_SOLICIT_RESPONSE = "solicit-response";
    public static final String FIELD_SOURCE_JSON = "source-json";
    ...
    public static final String FIELD_TO_INTERFACE = "to-interface";
    public static final String FIELD_TO_PLATFORM = "to-platform";
    public static final String FIELD_TO_SYSTEM = "to-system";
    ...
    public static final String STATUS_MSG_FIELD_ERROR = "Required fields are missing or invalid.";
