...
public class ConfigProperties {
    ...
    public static final String BROKER_REMOTE_PORT = "mqtt.ip.port.remote";

    /** Default value for the broker external IP port, integer value (for connections from other nodes). */
    public static final String BROKER_REMOTE_PORT_DEFAULT = "1883";

    /** Broker local IP port configuration property, integer value (for connections from this node). */
    public static final String BROKER_LOCAL_PORT = "mqtt.ip.port.local";

    /** Default value for the broker local IP port, integer value (for connections from this node). */
    public static final String BROKER_LOCAL_PORT_DEFAULT = "1884";

    /** Home node broker IP address configuration property. */
    public static final String HOME_BROKER_ADDRESS = "mqtt.ip.address.local";

    /** Default home node broker IP address. */
    public static final String HOME_BROKER_DEFAULT_ADDRESS = "127.0.0.1";

    /** Home node broker network interface configuration property. */
    public static final String HOME_BROKER_INTERFACE = "mqtt.ip.interface.local";
