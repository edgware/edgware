...
/**
 * A single file that contains all constants relating to the websockets and the Fabric.
 */
public final class Constants {
    ...
    // Error messages
    public static final String JSONParse = "There was an error parsing the JSON entered.";
    public static final String JSONMapping = "The JSON entered could not be correctly mapped to an object.";
