/*
 * Based on the D3 Collapsible Tree Layout example (http://mbostock.github.io/d3/talk/20111018/tree.html)
 * from the D3 gallery (https://github.com/mbostock/d3/wiki/Gallery).
 */
...
function addNode(topic, body) {
	...
	if(root.children=== undefined || root.children[0] === undefined){
