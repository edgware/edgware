...
public interface IFeedSubscription {
	...
	public TaskServiceDescriptor[] subscribe(String taskPattern, String platformPattern, String systemPattern,
			String feedTypePattern, ISubscriptionCallback callback) throws Exception, UnsupportedOperationException;
	...
	/**
	 * Tear down the subscription(s) to the active Fabric feed(s) managed by this instance.
	 * <p>
	 * This method will send an <em>unsubscribe</em> command to the local Fabric Manager to tear down the multi-hop
	 * connection from the local node to the target node(s) connected to the feed(s).
	 * </p>
	 * 
	 * @throws Exception
	...
	/**
	 * Answers the list of feeds to which this instance is subscribed (or to which it is attempting to subscribe).
	 * 
	 * @return the list of feeds.
	 */
	public TaskServiceDescriptor[] feedList();
