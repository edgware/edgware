...
public interface IConnectionMessage extends IServiceMessage {
    ...
    /**
     * Gets the ID of the system that generated the message.
     *
    ...
    /**
     * Sets the ID of the system that generated the message.
     *
     * @param system
     *            the system ID.
     */
    ...
    /**
     * Sets the ID of the service that generated the message.
     *
     * @param service
     *            the feed ID.
     */
