...
public class NotificationMessage extends ServiceMessage implements INotificationMessage {
    ...
    public NotificationMessage(IServiceMessage requestMessage) {
        ...
        setNotificationEvent(requestMessage.getEvent());
        setNotificationAction(requestMessage.getAction());
        setProperty(IServiceMessage.PROPERTY_NOTIFYING_NODE, homeNode());
        setProperty(IServiceMessage.PROPERTY_NOTIFYING_FABRIC_SERVICE, requestMessage.getServiceName());
        ...
        if (requestMessageRouting == null || homeNode().equals(requestMessageRouting.endNode())
            ...
            setEvent(IServiceMessage.EVENT_MESSAGE_HANDLED_IN_FLIGHT);
        }
    ...
    public String getNotificationEvent() {
        ...
        String event = getProperty(IServiceMessage.PROPERTY_NOTIFICATION_EVENT);
    ...
    /**
     * @see fabric.bus.messages.INotificationMessage#setNotificationEvent(String)
     */
    @Override
    public void setNotificationEvent(String event) {
        ...
        setProperty(IServiceMessage.PROPERTY_NOTIFICATION_EVENT, event);
