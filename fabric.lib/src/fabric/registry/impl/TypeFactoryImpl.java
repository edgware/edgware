...
public class TypeFactoryImpl extends AbstractFactory implements TypeFactory {
	 ...
	 */
	static {
		localQueryInstance = new TypeFactoryImpl(true);
		remoteQueryInstance = new TypeFactoryImpl(false);
	}

	private TypeFactoryImpl(boolean queryLocal) {
	...
	public static TypeFactory getInstance(boolean queryLocal) {
