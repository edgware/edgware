...
public class TaskNodeFactoryImpl extends AbstractFactory implements TaskNodeFactory {
     ...
     */
    static {
        localQueryInstance = new TaskNodeFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new TaskNodeFactoryImpl(QueryScope.DISTRIBUTED);
    }

    private TaskNodeFactoryImpl(QueryScope queryScope) {
    ...
    public static TaskNodeFactoryImpl getInstance(QueryScope queryScope) {
