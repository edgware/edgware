...
public class SystemFactoryImpl extends AbstractFactory implements SystemFactory {
     ...
     */
    static {
        localQueryInstance = new SystemFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new SystemFactoryImpl(QueryScope.DISTRIBUTED);
    }

    private SystemFactoryImpl(QueryScope queryScope) {
     ...
     * Class methods
     */
    public static SystemFactoryImpl getInstance(QueryScope queryScope) {
