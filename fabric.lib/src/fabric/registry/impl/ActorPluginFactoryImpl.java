...
public class ActorPluginFactoryImpl extends AbstractFactory implements ActorPluginFactory {
    ...
    static {
        localQueryInstance = new ActorPluginFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new ActorPluginFactoryImpl(QueryScope.DISTRIBUTED);
    }

    public static ActorPluginFactoryImpl getInstance(QueryScope queryScope) {
    ...
    private ActorPluginFactoryImpl(QueryScope queryScope) {
