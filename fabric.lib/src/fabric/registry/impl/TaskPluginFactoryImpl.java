...
public class TaskPluginFactoryImpl extends AbstractFactory implements TaskPluginFactory {
	...
	static {
		localQueryInstance = new TaskPluginFactoryImpl(true);
		remoteQueryInstance = new TaskPluginFactoryImpl(false);
	}

	public static TaskPluginFactoryImpl getInstance(boolean queryLocal) {
		if (queryLocal) {
	...
	private TaskPluginFactoryImpl(boolean queryLocal) {
