...
public class NodePluginFactoryImpl extends AbstractFactory implements NodePluginFactory {
	...
	static {
		localQueryInstance = new NodePluginFactoryImpl(true);
		remoteQueryInstance = new NodePluginFactoryImpl(false);
	}

	public static NodePluginFactoryImpl getInstance(boolean queryLocal) {
		if (queryLocal) {
	...
	private NodePluginFactoryImpl(boolean queryLocal) {
