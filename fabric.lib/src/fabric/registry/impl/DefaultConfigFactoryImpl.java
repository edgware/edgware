...
public class DefaultConfigFactoryImpl extends AbstractFactory implements DefaultConfigFactory {
	...
	static {
		localQueryInstance = new DefaultConfigFactoryImpl(true);
		remoteQueryInstance = new DefaultConfigFactoryImpl(false);
	}

	public static DefaultConfigFactory getInstance(boolean queryLocal) {
	...
	private DefaultConfigFactoryImpl(boolean queryLocal) {
