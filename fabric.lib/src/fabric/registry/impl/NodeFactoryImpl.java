...
public class NodeFactoryImpl extends AbstractFactory implements NodeFactory {
    ...
    static {
        localQueryInstance = new NodeFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new NodeFactoryImpl(QueryScope.DISTRIBUTED);
    }

    public static NodeFactory getInstance(QueryScope queryScope) {
    ...
    private NodeFactoryImpl(QueryScope queryScope) {
