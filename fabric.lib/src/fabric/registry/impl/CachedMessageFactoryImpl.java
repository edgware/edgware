...
public class CachedMessageFactoryImpl extends AbstractFactory implements CachedMessageFactory {
	...
	public static CachedMessageFactory getInstance(boolean queryLocal) {
		if (queryLocal) {
			if (localInstance == null) {
				localInstance = new CachedMessageFactoryImpl(true);
			}
			return localInstance;
		} else {
			if (remoteInstance == null) {
				remoteInstance = new CachedMessageFactoryImpl(false);
			}
			return remoteInstance;
		}
	}

	private CachedMessageFactoryImpl(boolean queryLocal) {
