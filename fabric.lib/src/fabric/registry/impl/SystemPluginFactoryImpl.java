...
public class SystemPluginFactoryImpl extends AbstractFactory implements SystemPluginFactory {
	...
	static {
		localQueryInstance = new SystemPluginFactoryImpl(true);
		remoteQueryInstance = new SystemPluginFactoryImpl(false);
	}

	public static SystemPluginFactoryImpl getInstance(boolean queryLocal) {
		if (queryLocal) {
	...
	private SystemPluginFactoryImpl(boolean queryLocal) {
