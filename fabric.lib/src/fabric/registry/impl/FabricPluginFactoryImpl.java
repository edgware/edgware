...
public class FabricPluginFactoryImpl extends AbstractFactory implements FabricPluginFactory {
    ...
    static {
        localQueryInstance = new FabricPluginFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new FabricPluginFactoryImpl(QueryScope.DISTRIBUTED);
    }

    public static FabricPluginFactoryImpl getInstance(QueryScope queryScope) {
    ...
    private FabricPluginFactoryImpl(QueryScope queryScope) {
    ...
    public String getUpdateSql(RegistryObject obj) {
        ...
        if (obj instanceof FabricPlugin) {
            ...
            buf.append("NAME='").append(plugin.getName()).append('\'').append(',');
