...
public class ServiceFactoryImpl extends AbstractFactory implements ServiceFactory {
    ...
    static {
        localQueryInstance = new ServiceFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new ServiceFactoryImpl(QueryScope.DISTRIBUTED);
    }

    public static ServiceFactoryImpl getInstance(QueryScope queryScope) {
    ...
    private ServiceFactoryImpl(QueryScope queryScope) {
