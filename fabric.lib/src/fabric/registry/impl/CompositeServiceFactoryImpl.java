...
public class CompositeServiceFactoryImpl extends AbstractFactory implements CompositeServiceFactory {
	...
	static {
		localQueryInstance = new CompositeServiceFactoryImpl(true);
		remoteQueryInstance = new CompositeServiceFactoryImpl(false);
	}

	public static CompositeServiceFactoryImpl getInstance(boolean queryLocal) {
		if (queryLocal) {
	...
	private CompositeServiceFactoryImpl(boolean queryLocal) {
