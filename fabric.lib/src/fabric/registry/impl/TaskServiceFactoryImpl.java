...
public class TaskServiceFactoryImpl extends AbstractFactory implements TaskServiceFactory {
	 ...
	 */
	static {
		localQueryInstance = new TaskServiceFactoryImpl(true);
		remoteQueryInstance = new TaskServiceFactoryImpl(false);
	}

	private TaskServiceFactoryImpl(boolean queryLocal) {
	 ...
	 */
	public static TaskServiceFactoryImpl getInstance(boolean queryLocal) {
