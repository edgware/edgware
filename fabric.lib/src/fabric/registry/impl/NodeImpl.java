...
public class NodeImpl extends AbstractRegistryObject implements Node {
    ...
    public Platform[] getPlatforms() {
        ...
        return PlatformFactoryImpl.getInstance(QueryScope.DISTRIBUTED).getPlatformsByNode(id);
    }
    ...
    public NodeIpMapping[] getAllIpMappings() {
        ...
        return NodeIpMappingFactoryImpl.getInstance(QueryScope.DISTRIBUTED).getAllMappingsForNode(id);
    }

    @Override
    public FabricPlugin[] getFabricPlugins(QueryScope queryScope) {

        return FabricPluginFactoryImpl.getInstance(queryScope).getFabricPluginsByNode(id);
    }

    @Override
    public NodePlugin[] getNodePlugins(QueryScope queryScope) {

        return NodePluginFactoryImpl.getInstance(queryScope).getNodePluginsByNode(id);
    }
