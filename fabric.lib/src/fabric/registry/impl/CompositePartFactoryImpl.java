...
public class CompositePartFactoryImpl extends AbstractFactory implements CompositePartFactory {
    ...
    static {
        localQueryInstance = new CompositePartFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new CompositePartFactoryImpl(QueryScope.DISTRIBUTED);
    }

    public static CompositePartFactoryImpl getInstance(QueryScope queryScope) {
    ...
    private CompositePartFactoryImpl(QueryScope queryScope) {
