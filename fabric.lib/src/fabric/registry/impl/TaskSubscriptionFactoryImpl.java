...
public class TaskSubscriptionFactoryImpl extends AbstractFactory implements TaskSubscriptionFactory {
     ...
     */
    static {
        localQueryInstance = new TaskSubscriptionFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new TaskSubscriptionFactoryImpl(QueryScope.DISTRIBUTED);
    }

    private TaskSubscriptionFactoryImpl(QueryScope queryScope) {
    ...
    public static TaskSubscriptionFactoryImpl getInstance(QueryScope queryScope) {
