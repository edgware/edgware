...
public class SystemWiringFactoryImpl extends AbstractFactory implements SystemWiringFactory {
	...
	static {
		localQueryInstance = new SystemWiringFactoryImpl(true);
		remoteQueryInstance = new SystemWiringFactoryImpl(false);
	}

	public static SystemWiringFactoryImpl getInstance(boolean queryLocal) {
	...
	private SystemWiringFactoryImpl(boolean queryLocal) {
