...
public class FactoryBuilder {
	 ...
	 * 
	 * @param factoryClass - a class that extends fabric.registry.impl.AbstractFactory
	 * @return an instance of the object factory or null if the specified class does not extend fabric.registry.impl.AbstractFactory.
	 * @throws FactoryCreationException if there is an error trying to instantiate an object from the specified class.
	 */
