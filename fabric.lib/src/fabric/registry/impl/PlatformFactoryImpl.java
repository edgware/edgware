...
public class PlatformFactoryImpl extends AbstractFactory implements PlatformFactory {
	 ...
	 */
	static {
		localQueryInstance = new PlatformFactoryImpl(true);
		remoteQueryInstance = new PlatformFactoryImpl(false);
	}

	public static PlatformFactoryImpl getInstance(boolean queryLocal) {
		if (queryLocal) {
	...
	private PlatformFactoryImpl(boolean queryLocal) {
