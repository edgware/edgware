...
public class NodeConfigFactoryImpl extends AbstractFactory implements NodeConfigFactory {
    ...
    static {
        localQueryInstance = new NodeConfigFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new NodeConfigFactoryImpl(QueryScope.DISTRIBUTED);
    }

    public static NodeConfigFactory getInstance(QueryScope queryScope) {
    ...
    private NodeConfigFactoryImpl(QueryScope queryScope) {
