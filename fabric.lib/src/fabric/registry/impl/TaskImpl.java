...
public class TaskImpl extends AbstractRegistryObject implements Task {
	...
	public TaskService[] getTaskServices() {
		...
		return TaskServiceFactoryImpl.getInstance(false).getTaskServicesByTask(id);
	}

	@Override
	public TaskSubscription[] getTaskSubscriptions() {

		return TaskSubscriptionFactoryImpl.getInstance(false).getTaskSubscriptionsByTask(id);
	}
