...
public class NodeNeighbourFactoryImpl extends AbstractFactory implements NodeNeighbourFactory {
	...
	static {
		...
		localQueryInstance = new NodeNeighbourFactoryImpl(true);

		/* Create an instance for distributed (Gaian) Registry operations */
		remoteQueryInstance = new NodeNeighbourFactoryImpl(false);
	}
	...
	protected NodeNeighbourFactoryImpl(boolean queryLocal) {
	...
	public static NodeNeighbourFactoryImpl getInstance(boolean queryLocal) {
		if (queryLocal) {
