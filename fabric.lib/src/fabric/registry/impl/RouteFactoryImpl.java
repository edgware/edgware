...
public class RouteFactoryImpl extends AbstractFactory implements RouteFactory {
     ...
     */
    static {
        localQueryInstance = new RouteFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new RouteFactoryImpl(QueryScope.DISTRIBUTED);
    }

    private RouteFactoryImpl(QueryScope queryScope) {
    ...
    public static RouteFactoryImpl getInstance(QueryScope queryScope) {
