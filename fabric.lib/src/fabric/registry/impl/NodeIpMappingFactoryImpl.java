...
public class NodeIpMappingFactoryImpl extends AbstractFactory implements NodeIpMappingFactory {
    ...
    static {
        ...
        localQueryInstance = new NodeIpMappingFactoryImpl(QueryScope.LOCAL);

        /* Create an instance for distributed (Gaian) Registry operations */
        remoteQueryInstance = new NodeIpMappingFactoryImpl(QueryScope.DISTRIBUTED);
    }
    ...
    private NodeIpMappingFactoryImpl(QueryScope queryScope) {
     ...
     */
    public static NodeIpMappingFactoryImpl getInstance(QueryScope queryScope) {
