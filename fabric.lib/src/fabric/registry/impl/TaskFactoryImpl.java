...
public class TaskFactoryImpl extends AbstractFactory implements TaskFactory {
     ...
     */
    static {
        localQueryInstance = new TaskFactoryImpl(QueryScope.LOCAL);
        remoteQueryInstance = new TaskFactoryImpl(QueryScope.DISTRIBUTED);
    }

    private TaskFactoryImpl(QueryScope queryScope) {
    ...
    public static TaskFactory getInstance(QueryScope queryScope) {
