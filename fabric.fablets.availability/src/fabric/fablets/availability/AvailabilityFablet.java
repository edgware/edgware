...
public class AvailabilityFablet extends FabricBus implements IFabletPlugin, ICallback {
	...
	public void stopPlugin() {
		...
		try {
			...
			logger.log(Level.WARNING, "Closure of channel for topic \"{0}\" failed: {1}", new Object[] {
					availabilityFeedsTopic, LogUtil.stackTrace(e)});
		...
		try {
			...
			try {
				...
				logger.log(Level.WARNING,
						...
						new Object[] {availabilityFeedsTopic, LogUtil.stackTrace(e)});
			}
	...
	public void handleMessage(Message message) {
		...
		try {
			...
			/* Unpack the message */
			messagePayload = new String(message.data);
			messageTopic = (String) message.topic;

			logger.log(Level.FINER, "Handling availability message on topic \"{0}\": {1}", new Object[] {messageTopic,
					messagePayload});
			...
			if (messagePayload.equals("0")) {

				availability = "UNAVAILABLE";

			} else if (messagePayload.equals("1")) {
			...
			logger.log(Level.WARNING, "Cannot update availability received on topic \"{0}\" (value \"{1}\"): {2}",
					new Object[] {messageTopic, messagePayload, LogUtil.stackTrace(e)});
